...
# ℹ️ Для Intel: Замените "amd-ucode" на "intel-ucode iucode-tool".
#################################################################
# 🧹 Очистка экрана терминала
clear
# #------------------------------------------------------------------------------
...
sed -i "s|^GRUB_CMDLINE_LINUX=.*|GRUB_CMDLINE_LINUX=\"rd.luks.name=${CRYPT_UUID}=cryptlvm root=UUID=${ROOT_UUID}\"|" /etc/default/grub
