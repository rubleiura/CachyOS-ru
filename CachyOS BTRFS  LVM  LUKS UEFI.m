...
pacman -S --noconfirm cachyos-rate-mirrors
...
pacman -S --noconfirm linux-cachyos-lts linux-cachyos-lts-headers linux-firmware
...
pacman -S --noconfirm cachyos-hooks cachyos-settings device-mapper efitools logrotate rebuild-detector perl poppler-glib
#------------------------------------------------------------------------------
...
pacman -S --noconfirm cachyos-rate-mirrors networkmanager-openvpn iwd wireless-regdb nss-mdns ethtool dnsmasq modemmanager xl2tpd bind ufw ufw-extras
# #------------------------------------------------------------------------------
...
pacman -S --noconfirm chwd bluez bluez-utils hwinfo dmidecode lsscsi mesa-utils sof-firmware bluez-hid2hci bluez-libs bluez-obex hwdetect hdparm
# 🔹 Bluetooth
...
pacman -S --noconfirm accountsservice plocate libgsf libopenraw cachyos-hello
# #------------------------------------------------------------------------------
...
pacman -S --noconfirm paru pacman-contrib pkgfile cachy-update glances duf meld lsb-release cachyos-packageinstaller shelly
# #------------------------------------------------------------------------------
# # 6. 💻 РЕДАКТОР
# #------------------------------------------------------------------------------
# [✅] 📦 nano | 📝 Простой консольный редактор. Резервный вариант.
# [✅] 📦 nano-syntax-highlighting | 🌈 Дополнительные схемы подсветки для nano.
pacman -S --noconfirm nano nano-syntax-highlighting
# #------------------------------------------------------------------------------
...
pacman -S --noconfirm power-profiles-daemon upower cpupower nilfs-utils fsarchiver dmraid mtools
# #------------------------------------------------------------------------------
# # 7. 🔋 КОЛЛЕКЦИЯ ОФИЦИАЛЬНЫХ ОБОЕВ CACHY OS
# #------------------------------------------------------------------------------
# ⚠️ Коллекция официальных обоев CachyOS
# 📦 cachyos-wallpapers
pacman -S --noconfirm cachyos-wallpapers
# #------------------------------------------------------------------------------
...
pacman -S --noconfirm haveged wget usbutils lsof dialog zip unzip unrar p7zip lzop lrzip sudo less bash-completion
# #------------------------------------------------------------------------------
...
pacman -S --noconfirm pipewire-alsa pipewire-pulse pipewire-jack pipewire-v4l2 pipewire-zeroconf
...
pacman -S --noconfirm alsa-utils alsa-plugins alsa-firmware pavucontrol gst-plugin-pipewire
...
pacman -S --noconfirm ttf-meslo-nerd awesome-terminal-fonts noto-fonts noto-fonts-emoji cantarell-fonts noto-fonts-cjk ttf-dejavu ttf-liberation ttf-bitstream-vera ttf-opensans char-white
...
pacman -S --noconfirm cachyos-kernel-manager grub-hook cachyos-grub-theme grub-btrfs-support snapper btrfs-assistant cachyos-plymouth-bootanimation cachyos-plymouth-theme
# #------------------------------------------------------------------------------
...
pacman -S --noconfirm plasma kde-system-meta dolphin-plugins kate konsole gwenview elisa okular ark cachyos-kde-settings
# pacman -S --noconfirm skanpage skanlite
pacman -Rns --noconfirm discover
# 📦 Кодеки, интеграция, порталы Wayland/XDG и поддержка Wayland для Qt
pacman -S --noconfirm ffmpegthumbs poppler-glib packagekit xdg-desktop-portal xdg-desktop-portal-kde qt6-wayland
...
pacman -S --noconfirm gnome gnome-tweaks gnome-themes-extra gnome-shell-extensions dconf-editor file-roller gnome-browser-connector cachyos-gnome-settings
...
pacman -S --noconfirm xfce4 xfce4-goodies mugshot pavucontrol ristretto thunar-archive-plugin cachyos-xfce-settings
# 📦 Сетевые апплеты
