...
mount -o defaults,subvol=@root /dev/sda2 /mnt/root
mount -o defaults,subvol=@home /dev/sda2 /mnt/home
mount -o defaults,subvol=@srv /dev/sda2 /mnt/srv
mount -o defaults,subvol=@log /dev/sda2 /mnt/var/log
mount -o defaults,subvol=@tmp /dev/sda2 /mnt/var/tmp
mount -o defaults,subvol=@cache /dev/sda2 /mnt/var/cache
...
# #------------------------------------------------------------------------------
# Настройка HOOKS
sed -i "s|^HOOKS=(.*)|HOOKS=(base udev autodetect modconf kms block keyboard keymap resume filesystems fsck)|" /etc/mkinitcpio.conf
# Настройка MODULES
...
# Настраиваем DEFAULT: добавляем resume и современный udev.log_priority=3
...
# Очищаем переменную LINUX, чтобы избежать дублирования или конфликтов
